...
import { Card, Typography, Row, Col, Image, Flex, QRCode, Layout, } from "antd";
                ...
                <Flex justify="space-between">
                  <div>
                    ...
                    <Typography.Text style={{ display: "block" }}>
                      Date de naissance:{" "}
                      {new Date(
                        enrolledStudent?.common_enrollment_infos
                          .date_of_birth || ""
                      ).toLocaleDateString()}
                    </Typography.Text>
                    <Typography.Text>
                  ...
                  <div>
                    <Image
                      alt="Photo"
                      src={
                        getPublicR2Url(enrolledStudent?.user.avatar) ||
                        undefined
                      }
                      height="auto"
                      width={96}
              ...
              >
                <div className="text-center">
                  ...
                  <Typography.Paragraph>
                    ...
                    {institution?.acronym || "l'institution"}, en cas de perte
                    la retourner à l&apos;
                    {institution?.acronym || "l'institution"}. Les autorités
                    tant civiles que militaires sont priées d&apos;apporter
                    assistance au porteur de la présente.
                  </Typography.Paragraph>
                  <Typography.Title
                    level={5}
                    style={{ textTransform: "uppercase", textAlign: "center" }}
