...
import { getRoleName, getSuperUsers } from "@/lib/api";
...
type ListAdminUsersProps = {
  groups?: Group[];
  roles?: Role[];
  permissions?: Permission[];
};

export const ListAdminUsers: FC<ListAdminUsersProps> = ({
  groups,
  roles,
  permissions,
}) => {
  const {
    ...
    queryKey: ["users", "is_superuser", true],
    queryFn: getSuperUsers,
  });
