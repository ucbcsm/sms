...
export function JurysList() {
    ...
    const {data:jurys, isPending, isError} = useQuery({
      ...
      <Table
        ...
        columns={[
          ...
          },
          {
            ...
            dataIndex: "secretary",
            key: "secretary",
            render: (_, record) => `${record.secretary.user?.first_name} ${record.secretary.user?.last_name} ${record.secretary.user?.surname}`,
            ellipsis: true,
          },
          {
            title: "Membres",
