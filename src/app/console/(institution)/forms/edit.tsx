...
import { CloseOutlined, EditOutlined, FileImageOutlined, UploadOutlined } from "@ant-design/icons";
    ...
    mutateAsync(
      {
        ...
        params: { ...values, logo: values.logo || null },
      },
      {
        onSuccess: () => {
      ...
      >
        ...
        >
          ...
          <Form.Item
            label="Acronyme"
            name="acronym"
            rules={[{ required: true, message: "Veuillez entrer l'acronyme" }]}
          >
            <Input />
          </Form.Item>
          <Form.Item
