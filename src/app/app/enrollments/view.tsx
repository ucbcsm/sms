...
//   setEditedApplication,
  ...
  useEffect(() => {
    ...
    } else if (typeof application!=="undefined" && application.admission_test_result.length > 0) {
  ...
  useEffect(() => {
    ...
    } else if (typeof application!=="undefined" && application.application_documents.length > 0) {
      form.setFieldsValue({
        ...
        <Layout.Header>
          ...
          <Space>
            <Button
              ...
              type="text"
              disabled={isPending}
              title="Fermer cette candidature"
            />
          </Space>
        </Layout.Header>
