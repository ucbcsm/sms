        ...
        <Col xs={24} sm={24} md={6} lg={8}>
          <Card variant="borderless">
            <Flex justify="space-between" align="flex-end">
              ...
              />
              <Link
                href={`/t-space/courses/course/${course.id}/?tab=hours-tracking`}
              >
          ...
          <Card variant="borderless" style={{ marginTop: 16 }}>
            <Flex justify="space-between" align="flex-end">
              ...
              />
              <Link href={`/t-space/courses/course/${course.id}/?tab=students`}>
                <Button type="link">Voir</Button>
              </Link>
            </Flex>
          </Card>
              ...
              items={[
                {
                  ...
                  label: "Département",
                  children:
                    course?.departements.map((dep) => dep.name).join(", ") ||
                    "",
                },
                {
                  key: "year",
