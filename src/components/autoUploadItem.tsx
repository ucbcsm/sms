...
// import { Upload, Image, Button, Space, Tag, App } from "antd";
// import type { UploadProps, FormInstance } from "antd";
// import { RcFile } from "antd/es/upload";
// import { CheckCircleFilled, CloseOutlined, ExportOutlined, LoadingOutlined, UploadOutlined } from "@ant-design/icons";
...
//   // Helper: only revoke blob/object URLs (not remote urls)
...
//   // helper to guess if a URL is an image
...
//   // Initialize from form value or initialValue prop
//   useEffect(() => {
//     const current = form.getFieldValue(name);
//     if (current) {
//       // prefer form value if already present
//       setUploaded(true);
//       setPreview(getPublicR2Url(current));
//     } else if (initialValue) {
//       // set form and preview from initialValue
//       form.setFieldValue(name, initialValue);
//       if (onChange) onChange(initialValue);
//       setUploaded(true);
//       setPreview(getPublicR2Url(initialValue));
//     }
//     // cleanup on unmount: revoke any blob preview
//     return () => {
...
//   useEffect(() => {
//     // ensure we revoke previous blob URLs when preview changes
//     return () => {
//       // nothing here; cleanup already handled in places where preview is replaced
//     };
//   }, [preview]);

//   const handleBeforeUpload = async (file: RcFile) => {
//     // if user starts a new upload, remove previous uploaded flag
//     setUploaded(false);
...
//     // Si c’est une image, créer un preview instantané (et révoquer l'ancien si blob)
//     if (file.type.startsWith("image/")) {
//       revokeIfBlob(preview);
//       const p = URL.createObjectURL(file);
//       setPreview(p);
//     } else {
//       // remove previous preview if new file is not an image
//       revokeIfBlob(preview);
//       setPreview(null);
//     }
...
//     // prevent antd from auto adding to list (we handle preview)
//     return Upload.LIST_IGNORE;
//   };
