...
export async function createApplication(params: ApplicationFormDataType) {
  const res = await api.post(`/apparitorat/application/`, {
    ...
    spoken_language: params.spoken_language,
    ...
    is_foreign_registration: params.is_foreign_registration || null,
...
export async function updateApplication({
  ...
  const res = await api.post(`/apparitorat/application/${id}`);
  return res.data;
}
